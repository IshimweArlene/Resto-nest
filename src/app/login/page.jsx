  ...
  return (
    <div className="w-full h-screen mb-24">
      <div className="flex-1 flex flex-col items-center min-h-screen bg-white">
        <form className="w-full sm:w-4/5 md:w-3/5 lg:w-2/3 bg-[#FFF6EA] p-8 rounded-lg my-20">
          ...
          <div className="flex flex-col items-center gap-4 mt-10 mb-10">
            ...
            <button className="bg-amber-500 text-center text-xl md:text-2xl text-black font-bold w-full md:w-2/3 h-16 md:h-20 rounded-xl cursor-pointer">
              LOGIN
            </button>

            <p className="text-xl md:text-2xl text-black">OR</p>

            <button className="border-3 border-amber-600 flex items-center justify-center text-xl md:text-3xl text-gray-800 font-extrabold w-full md:w-2/3 h-16 md:h-20 rounded-xl cursor-pointer">
